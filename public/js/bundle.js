...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZWFzdGVtcGxveWVlciIsImEiOiJja2wyaGgwY2QxZTh2MzBtc2RnMzcxdm9iIn0.bw57IGksZ71fscCHo4I1Zg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/eastemployeer/ckl2hyfhh10jm19qoq52yw5ax',
    scrollZoom: false //   center: [-118.11349, 34.111745], //tak jak w MongoDB, najpierw longitude potem latitude, odwrotnie jest w requestcie do API
    //   zoom: 4,
    //   interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    }).setLngLat(loc.coordinates).addTo(map); //popup - nie dziala z jakiegos powodu
    //   new mapboxgl.Popup()
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            //public key
            stripe = Stripe('pk_test_51IOi4VGOO1NWTN9sDcB2MgrUSKMjDtIGoesEGXohj4nx6fIlWyCdXrupVzrqNeq8ZOKn3o8m66wPCnH4lGtihctP00SacDiGj0'); //1) Get the checkout session from the server
...
var userPasswordSettings = document.querySelector('.form-user-password');
var logOutBtn = document.querySelector('.nav__el--logout'); //tour.pug
...
if (userSettings) {
  userSettings.addEventListener('submit', function (e) {
    e.preventDefault(); //tworzenie multi formularza - potrzebne w przypadku przesylania plikow
...
if (userPasswordSettings) {
  userPasswordSettings.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordConfirm = document.getElementById('password-confirm').value; //await po to aby mozna było wyczyscic inputy - funkcja sie tu zatrzyma "poczeka" az do otrzymania wartosci z promise'a
